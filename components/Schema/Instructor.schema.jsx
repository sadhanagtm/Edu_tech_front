...
export const AddStudentSchema=yup.object().shape({
    ...
    email:yup.string().email("email invalid !!  please provide a valid email").required('email is required'),
    contact:yup.string().min(10,'contact no must  be more then or equals to  10 digits'),
